...
echo Lancement de l'app d'analyse sur %URL%...
start "" "%URL%"
call "%CONDA_CMD%" run -n "%ENV_NAME%" python -m streamlit run apps\channel_analysis\droplets_channel_app.py --server.port "%PORT%" --server.headless true
